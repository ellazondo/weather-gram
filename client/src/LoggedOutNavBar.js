      ...
      <div class="hidden lg:flex items-center ml-auto">
        <div class="mr-12">
          <ul class="hidden xl:flex items-center">
            ...
            <li class="mr-16"><a class="inline-block text-base font-medium text-black" href="#"><Link to="/login">Login</Link></a></li> 
            
            <li><a class="inline-block text-base font-medium text-black" href="#"><Link to="/signup">Sign Up</Link></a></li>
            
          </ul> 
        </div>
        <div class="w-px h-12 mx-6 bg-gray-200"></div>
        <a class="inline-flex mr-12 items-center" href="/mycloset">
          <div class="relative w-10 h-10 rounded-full mr-4">
            ...
            alt="" />
            <div class="absolute bottom-0 right-0 -mr-px -mb-1 flex w-4 h-4 items-center justify-center rounded-full bg-indigo-500 text-white text-xs font-bold">0</div>
          </div>
          {/* <span class="font-medium">No one signed in</span> */}
        </a>
        {/* <a class="relative group inline-flex h-12 w-24 items-center justify-center font-semibold rounded-lg bg-blue-500 overflow-hidden" href="/login">
          <span class="relative z-10 text-black group-hover:text-white transition duration-500">Login</span>
    ...
    <nav class="relative pt-8 pb-8 bg-white h-full overflow-y-auto">
      <div class="flex flex-col px-6 h-full">
        ...
        <ul class="w-full mb-auto pb-16">
          ...
          <li class="mb-6"><a class="inline-block text-base font-medium text-black" href="#">Community</a><Link to="/todaysfeed">Today's Feed</Link></li>
          
          <li class="mb-6"><a class="inline-block text-base font-medium text-black" href="#">Story</a><Link to="/outfitinspo">Inspo Page</Link></li>
          
          <li><a class="inline-block text-base font-medium text-black" href="#">Pricing</a><Link to="/users">Users </Link></li>
