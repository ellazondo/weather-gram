...
export default function Feed2({
  ...
  return (
    <>
      {ready ? (
        <section class="pb-20 2xl:py-40">
          <div class="lg:flex justify-center mb-4 mx-auto pb-6">
            <WeatherInfo2
              data={weatherData}
          ...
          <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
              ...
              <div class="mt-20 text-center">
                <a
                  class="inline-block py-4 px-12 text-white font-bold bg-blue-500 hover:bg-blue-600 rounded-full"
                  href="#"
                >
                  See all
                </a>
