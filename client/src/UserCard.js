...
const updatedAt = new Date('2023-03-27T17:55:45.794Z').toLocaleString(undefined, dateOptions);
  ...
  return (
    ...
    {model ? (
            ...
            null}
    <img 
    class="md:transform group-hover:translate-y-3 block mb-5 w-3/4 h-3/4 max-h-72 hover:max-h-full transition-all duration-1000 object-cover rounded-lg transition duration-1000" 
